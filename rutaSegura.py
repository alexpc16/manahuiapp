...
def Shortest_path_Dijkstra1(Grafo, Origin_vertex, Destination_vertex):
    ...
    while len(Posibles_ways) > 0:
        try:
            ...
            # Capturar la excepción de índice si la cola está vacía
            break
...
def crearMapa(recorrido1, recorrido2, recorrido3):
  ...
  myGmap.apikey = "AIzaSyAZyDasSfjlq8aVjqYANYcU68xt4wES928"  
  myGmap.draw('mapa_google.html')
  webbrowser.open_new_tab('mapa_google.html')
